...
1.	Identity the countries as <p>HIGH RISK TRAVEL <span style="color:red">some <em>red</em> text</span>.</p> destination countries for Internship or Project work for next two years.
